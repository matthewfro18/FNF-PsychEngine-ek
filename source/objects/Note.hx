...
class Note extends FlxSprite
{
	...
	**/
	...
	public function new(strumTime:Float, noteData:Int, ?prevNote:Note, ?sustainNote:Bool = false, ?inEditor:Bool = false, ?createdFrom:Dynamic = null, noteStyle:String = "normal", inCharter:Bool = false, guitarSection:Bool = false)
	{
